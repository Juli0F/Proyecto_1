...
public final class Atrasados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pedidos Atrasados"));
        ...
        tablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Tienda", "Codigo Pedido", "Total", "Fecha", "Dias Transito", "Tiempo Estimado"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.pedidos = new ArrayList<>();
        pedidos.addAll(manager.getTiendaDAO().pedidosConAtraso(Log.codigoTienda, java.sql.Date.valueOf(localDate)));
        verificar();
