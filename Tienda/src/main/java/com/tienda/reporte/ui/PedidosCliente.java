 ...
 * @author julio
 */
public final class PedidosCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tablePrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Tienda", "Codigo Pedido", "Total", "Fecha"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (tablePrincipal.getRowCount() > 0) {
            ...
            crearHtml.imprimirReporte(path, area, "Pedidos de Un Cliente " + LocalDate.now());
    ...
    public void datos() {
        ...
        reporte.addAll(manager.getPedidoDAO().reporteSeis(nitCliente, Log.codigoTienda, inicio, fechaFinal));
