...
public class ClienteUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 70, -1));
        ...
        tableView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Dpi", "Nit", "Nombre", "Telefono", "Direccion", "Correo Electronico", "Credito"
            }
        ) {
        ...
        txtCredito.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.005656446"))));
        jPanel1.add(txtCredito, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 259, 160, 30));
...
//
    ...
    public void fillTable(List<ClienteDTO> listadoClientes) {
        DefaultTableModel tableModel = (DefaultTableModel) tableView.getModel();
        tableModel.setNumRows(0);

        listadoClientes.forEach(tiendax -> {
 ...
 private void actionBuscarTxt() {
    ...
    private void accionTable() {
        tableView.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                credito = (BigDecimal) tableView.getModel().getValueAt(row, 6);
                System.out.println("Codigo" + dpi);

                setTextField(dpi, nit, nombre, telefono, direccion, email, credito);
            }
        });
    ...
    private void setTextField(String codigo, String nombre, String direccion, String telefono, String telefono2, String email, Object credito) {
        ...
        txtCredito.setText((String) credito);
    }
    private int row;
